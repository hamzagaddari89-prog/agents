...
- Mark deliberate simplifications that cut a real corner with a known ceiling (global lock, O(nآ²) scan, naive heuristic) with a `ponytail:` comment naming the ceiling and upgrade path.
